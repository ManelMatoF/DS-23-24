...
public class TrackTest2 {
    ...
    @Test
    void testGetTrackPos() {
        assertEquals("A",beatlesPennyLanePromo01.getTrackPos());
    }

    @Test
    void testGetTrackId() {
        assertEquals("6f5f27e2-fe6d-4c98-be0b-1e58d569909c",beatlesPennyLanePromo02.getTrackId());
    }

    @Test
    void testGetArtist() {
        assertEquals("The Beatles",beatlesSFFPennyLane01.getArtist());
    }

    @Test
    void testGetTitle() {
        assertEquals("Penny Lane",beatlesSFFPennyLane02.getTitle());
    }

    @Test
    void testGetDuration() {
        assertEquals(238,beatlesSFFDigital01.getDuration());
    }
